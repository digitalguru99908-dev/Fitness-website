        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-7xl font-display font-bold text-white mb-4 tracking-tighter">
              4.2<span className="text-4xl text-muted-foreground">/5.0</span>
            </div>
            ...
            <p className="text-xl text-gray-300 font-medium">Based on 40+ Google Reviews</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {reviews.map((item, i) => (
              <motion.div
                ...
                className="bg-[#080808] border border-white/5 p-8 relative flex flex-col hover:border-primary/30 transition-colors"
              >
          ...
          <div className="text-center">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-flex items-center justify-center bg-primary text-white px-8 py-4 font-display font-bold text-xl uppercase tracking-wider skew-x-[-10deg] hover:bg-primary/90 transition-colors box-glow hover:scale-105 active:scale-95"
            >
