...
export function WhatsAppButton() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="flex group fixed bg-[#25D366] text-white rounded-full shadow-lg shadow-[#25D366]/30 hover:scale-105 hover:shadow-[#25D366]/50 transition-all duration-300 items-center h-12 md:h-14 bottom-16 right-4 md:bottom-6 md:right-6 z-50"
